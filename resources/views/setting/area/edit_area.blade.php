                                    ...
                                    <div>
                                        <section>
                                            ...
                                            <div class="input-field col m6 s12">
	                                            ...
	                                            <input  id="area" name="city_name" class="masked" type="text" value="{{$area[0]->city_name}}" required>
                                            </div>
                                            <div class="input-field col m6 s12">
	                                         <select name="sort" id="sort" autocomplete="off">
												      <option value="" disabled selected>Choose your option</option>
												      @for ($i = 1; $i <= 5; $i++)
												      	<option value="{{$i}}" {{$area[0]->sort == $i  ? 'selected' : ''}}>{{$i}}</option>
												      @endfor
                                            ...
                                            <div class="input-field col m6 s12">
	                                            ...
	                                            <input  id="short_name" name="short_name" class="masked" value="{{$area[0]->short_name}}" type="text" required>
	                                            
                                            </div>
                                            <div class="input-field col m6 s12">
	                                             <input type="checkbox"  id="status" name="status" value="1" @if($area[0]->status == '1' ) checked @endif>
